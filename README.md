...
### 1. Rodar o pipeline manualmente
...
- Integração com armazenamento em nuvem (AWS S3 ou Azure Blob)
- Uso de banco de dados analítico
- Implementação de streaming em tempo real (Kafka)
